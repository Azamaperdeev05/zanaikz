export const translations = {
  kk: {
    ...
    lawyers: {
      title: 'Заңгерлер',
      subtitle: 'Қазақстанның тәжірибелі заңгерлері мен адвокаттары',
      searchPlaceholder: 'Аты-жөні немесе мамандығы...',
      allCities: 'Барлық қалалар',
      notFound: 'Заңгерлер табылмады',
      call: 'Қонырау шалу',
      write: 'Жазу',
      noContact: 'Байланыс жоқ',
    },
    templates: {
      title: 'Құжат үлгілері',
      subtitle: 'ҚР заңнамасына сәйкес дайын құжаттар',
      all: 'Барлығы',
      open: 'Ашу',
    },
    calculators: {
      title: 'Калькуляторлар',
      alimony: 'Алимент',
      duty: 'Мем. баж',
      maternity: 'Декреттік төлем',
      penalty: 'Өсімпұл',
      tax: 'Жалақыдан салық',
      pdd: 'Жол айыппұлы',
      carTax: 'Көлік салығы',
  ...
  ru: {
    ...
    lawyers: {
      title: 'Юристы',
      subtitle: 'Опытные юристы и адвокаты Казахстана',
      searchPlaceholder: 'Имя или специализация...',
      allCities: 'Все города',
      notFound: 'Юристы не найдены',
      call: 'Позвонить',
      write: 'Написать',
    ...
    templates: {
      ...
      subtitle: 'Готовые документы согласно законодательству РК',
      all: 'Все',
      open: 'Открыть',
    },
    calculators: {
      ...
      maternity: 'Декретные',
      penalty: 'Пеня',
      tax: 'Налог с зарплаты',
      pdd: 'Штраф ПДД',
      carTax: 'Налог на транспорт',
      loan: 'Кредит',
      mrp: 'МРП',
      severance: 'Компенсация',
    }
  }
};
